...
const SignUp = () => {
    ...
    return (
        <div className='max-w-7xl mx-auto px-4 py-8 sm:py-12 flex flex-col items-center justify-center min-h-[80vh]'>
            <Card className='w-full max-w-md border border-zinc-200 dark:border-zinc-800 p-5 sm:p-8 shadow-sm rounded-2xl bg-[#fcfcfb] dark:bg-zinc-900 mt-12'>
                <div className='text-center mb-6'>
                    <h1 className='text-3xl font-bold text-zinc-800 dark:text-zinc-100'>Create Account</h1>
                ...
                <Form className="flex w-full flex-col gap-4" onSubmit={onSubmit}>
                    ...
                    <TextField name="photoUrl" type="url" className="flex flex-col gap-1.5 w-full">
                    ...
                    >
                        <Label className="text-xs font-bold uppercase tracking-wider text-zinc-500 dark:text-zinc-400">Confirm Password</Label>
                        <Input
                        ...
                        />
                        {passwordsMismatch && (
                            <p className="text-rose-500 text-xs mt-0.5 font-medium">Passwords do not match</p>
                        )}
                    </TextField>
